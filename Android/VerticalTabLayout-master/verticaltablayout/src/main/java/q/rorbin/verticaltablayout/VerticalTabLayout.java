        ...
        if (mPagerAdapter != null) {
            ...
            if (mPagerAdapter instanceof TabAdapter) {
                ...
                for (int i = 0; i < adapterCount; i++) {
                    String title = mPagerAdapter.getPageTitle(i) == null ? "tab" + i : mPagerAdapter.getPage(i).toString();
                    addTab(new QTabView(mContext).set(
                            new QTabView.Tab.Builder().setContent(title).build()));
                }
            }
