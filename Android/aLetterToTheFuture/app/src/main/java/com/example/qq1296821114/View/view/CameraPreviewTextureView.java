...
/**
 * texture view用来显示文本流，可以做一些旋转，和透明变换
 * 原作者又进行了封装。
 * GLMultiTexProducerView->GLMultiTexConsumerView->BaseGLCanvasTextureView->BaseGLTextureView->TextureView 调用最后的texture view
 * 这个是显示用的view用来展示
 */
