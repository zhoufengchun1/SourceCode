...
public class SearchEditView extends EditText implements View.OnFocusChangeListener, TextWatcher
{
...
//        }
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count)
    {
        ...
        {
            drawableDel = this.getResources().getDrawable(R.drawable.icon_clear);
        }
    }
