...
def handleAudio(filePath, args):
    ...
    SPECTROGRAM_FILENAME = INPUT_FILENAME + fileSuffix("Input Spectrogram", fft=args.fft, iter=args.iter,
                                                       sampleRate=sampleRate) + ".png"
...
def handleImage(fileName, args, phase=None):
    ...
    saveSpectrogram(sanityCheck, fileName + fileSuffix("Output Spectrogram", fft=args.fft, iter=args.iter,
                                                       sampleRate=sampleRate) + ".png")
